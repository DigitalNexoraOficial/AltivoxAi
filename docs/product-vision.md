...
Referencia obligatoria para todos los desarrollos futuros ([`flow.md`](./flow.md)):
...
Lead
  ...
  → Control de calidad
  → Versión candidata
  → URL privada de revisión
  → Cambios solicitados  ⟲ (vuelve a ejecución/QA según corresponda)
  → Aprobación
  → Entrega
  → Despliegue opcional
  → Mantenimiento
