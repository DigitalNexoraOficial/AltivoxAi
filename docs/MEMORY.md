...
**Bloques 0–7 cerrados.** Código **`v0.7.0-b7`**.  
**Producción:** **PENDING** — [`production/PRODUCTION-ACTIVATION-REPORT.md`](./production/PRODUCTION-ACTIVATION-REPORT.md).  
**Próximo tras ACTIVE ops:** fases 8–9 — **sin B8**.  
Ops: env · SQL · Upstash · backup · smoke HTTP.
