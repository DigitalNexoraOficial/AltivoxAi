...
export function Hero() {
  ...
  return (
    <section id="home" className="cinematic-stack mesh-divider relative flex min-h-[100svh] items-center overflow-hidden pt-28">
      <HeroAtmosphere />
      ...
      <div className="content-wrap relative z-10 px-6 pb-20 md:px-10">
        <div className="grid gap-10 lg:grid-cols-[0.86fr_1.14fr] lg:items-end">
          ...
          >
            ...
            <h1 className="heading-display mt-4 text-5xl leading-[0.92] md:text-7xl xl:text-[7.4rem]">
              {t.hero.title}
              <br />
              <span className="text-gradient">{t.hero.titleAccent}</span>
            </h1>
            <p className="mt-5 max-w-md text-sm font-light leading-relaxed text-mist md:text-base">{shortDesc}</p>
          ...
          <motion.aside
            ...
            className="hero-dock ui-lift relative rounded-[2rem] p-5 md:p-7"
          >
            <div className="pointer-events-none absolute -right-5 -top-4 z-20 hidden rounded-full border border-cyan/40 bg-cyan/20 px-3 py-1 font-mono text-[10px] uppercase tracking-widest text-cyan lg:block">
              Live
            </div>
