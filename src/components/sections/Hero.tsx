    ...
    <section id="home" className="cinematic-stack relative flex min-h-[100svh] items-center overflow-hidden pt-28">
      ...
      <div className="content-wrap relative z-10 px-6 pb-16 md:px-10 md:pb-24">
        ...
        >
          ...
          <p className="mt-8 font-display text-[11px] tracking-[0.32em] text-cyan md:text-xs">
            ALTIVOX<span className="text-white">AI</span>
            <span className="ml-2 text-mist-muted">® AI-NATIVE STUDIO</span>
          </p>

          <h1 className="heading-serif mt-6 text-5xl leading-[0.92] md:text-7xl lg:text-[5.75rem]">
            {t.hero.title}
            <br />
          ...
          <p className="mt-6 font-mono text-[10px] uppercase tracking-[0.18em] text-mist-muted">{t.hero.risk}</p>
        </motion.div>
          ...
          <div className="hero-dock relative overflow-hidden rounded-[2rem] p-5 md:p-7">
            ...
            <div className="relative grid gap-4 md:grid-cols-12">
              <div className="rounded-2xl border border-white/10 bg-black/40 p-5 md:col-span-5">
                ...
                <p className="mt-3 font-serif text-3xl text-white">AI Agency OS</p>
              ...
              <div className="grid gap-4 sm:grid-cols-2 md:col-span-7">
                <div className="hero-metric">
                  ...
                  <p className="mt-2 font-serif text-3xl text-white">~120ms</p>
                </div>
                <div className="hero-metric">
                  <p className="text-[10px] uppercase tracking-widest text-mist-muted">Modes</p>
                  <p className="mt-2 font-serif text-3xl text-white">6 agents</p>
                </div>
